...
// 2023-07-28 Jonghun
bool ImGui::Selectable(const char* label_begin, const char* label_end, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
	ImGuiWindow* window = GetCurrentWindow();
	if (window->SkipItems)
		return false;
...
// 2023-08-07 Jonghun
bool ImGui::Selectable(const char* label_begin, const char* label_end, bool* p_selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
	if (Selectable(label_begin, label_end, *p_selected, flags, size_arg))
	{
		*p_selected = !*p_selected;
		return true;
	}
