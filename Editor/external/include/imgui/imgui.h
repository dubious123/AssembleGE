...
struct ImVec2
{
	...
	constexpr ImVec2 operator+(const ImVec2 l)
	{
		return { x + l.x, y + l.y };
	}
	...
	constexpr ImVec2 operator*(const float l)
	{
		return { x * l, y * l };
	}
...
namespace ImGui
{
	...
	// 2023-07-28
	IMGUI_API bool Selectable(const char* label_begin, const char* label_end, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
	// 2023-08-07
	IMGUI_API bool Selectable(const char* label_begin, const char* label_end, bool* p_selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
