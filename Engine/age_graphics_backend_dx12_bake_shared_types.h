...
#define ENV_LIGHT_BRDF_LUT_SAMPLE_COUNT	  4096
#define ENV_LIGHT_GGX_SAMPLE_COUNT		  4096
#define ENV_LIGHT_EIS_SAMPLE_COUNT		  4096
#define ENV_LIGHT_IRRADIANCE_SAMPLE_COUNT 4096
