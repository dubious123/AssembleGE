...
namespace age::graphics::render_pipeline::forward_plus
{
	...
	depth_stage::init(graphics::root_signature::handle h_root_sig) noexcept
	{
		...
		auto as_byte_code = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_opaque_as) });
		auto ms_byte_code = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_depth_ms) });
...
namespace age::graphics::render_pipeline::forward_plus
{
	...
	skybox_stage::init(graphics::root_signature::handle h_root_sig) noexcept
	{
		...
		h_pso = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_ms{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_skybox_ms) }) },
			pss_ps{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_skybox_ps) }) },
			pss_primitive_topology{ .subobj = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE },
	...
	void
	skybox_stage::bind_rtv_dsv(graphics::resource_handle h_main_buffer,
	...
	inline void
	skybox_stage::execute(uint32 env_light_count) noexcept
	{
...
namespace age::graphics::render_pipeline::forward_plus
{
	...
	light_culling_stage::init(graphics::root_signature::handle h_root_sig) noexcept
	{
		...
		h_pso_init = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_cs{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_light_init_cs) }) });
		...
		h_pso_cull = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_cs{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_light_cull_cs) }) });
		...
		h_pso_sort_histogram = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_cs{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_sort_histogram_cs) }) });
		...
		h_pso_sort_prefix = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_cs{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_sort_prefix_cs) }) });
		...
		h_pso_sort_scatter = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_cs{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_sort_scatter_cs) }) });
		...
		h_pso_zbin = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_cs{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_light_zbin_cs) }) });
		...
		h_pso_tile = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_cs{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_light_tile_cs) }) });
...
namespace age::graphics::render_pipeline::forward_plus
{
	...
	opaque_stage::init(graphics::root_signature::handle h_root_sig) noexcept
	{
		...
		h_pso = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_as{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_opaque_as) }) },
			pss_ms{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_opaque_ms) }) },
			pss_ps{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_opaque_ps) }) },
			pss_primitive_topology{ .subobj = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE },
			pss_render_target_formats{ .subobj = D3D12_RT_FORMAT_ARRAY{ .RTFormats{ DXGI_FORMAT_R16G16B16A16_FLOAT }, .NumRenderTargets = 1 } },
			pss_depth_stencil_format{ .subobj = DXGI_FORMAT_D32_FLOAT },
			pss_rasterizer{ .subobj = defaults::rasterizer_desc::backface_cull },
...
namespace age::graphics::render_pipeline::forward_plus
{
	...
	transparent_stage::init(graphics::root_signature::handle h_root_sig) noexcept
	{
		...
		h_pso_rt = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_cs{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_transparent_rt_cs) }) });
		...
		h_pso_draw = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_ms{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_presentation_ms) }) },
			pss_ps{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_transparent_blend_ps) }) },
			pss_primitive_topology{ .subobj = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE },
			pss_render_target_formats{ .subobj = D3D12_RT_FORMAT_ARRAY{ .RTFormats{ DXGI_FORMAT_R16G16B16A16_FLOAT }, .NumRenderTargets = 1 } },
			pss_rasterizer{ .subobj = defaults::rasterizer_desc::no_cull },
...
namespace age::graphics::render_pipeline::forward_plus
{
	...
	post_process_stage::init(graphics::root_signature::handle h_root_sig) noexcept
	{
		...
		h_pso = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_ms{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_presentation_ms) }) },
			pss_ps{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_post_process_ps) }) },
			pss_primitive_topology{ .subobj = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE },
			pss_render_target_formats{ .subobj = D3D12_RT_FORMAT_ARRAY{ .RTFormats{ DXGI_FORMAT_R16G16B16A16_FLOAT }, .NumRenderTargets = 1 } },
			pss_rasterizer{ .subobj = defaults::rasterizer_desc::no_cull },
			pss_blend{ .subobj = defaults::blend_desc::alpha },
...
namespace age::graphics::render_pipeline::forward_plus
{
	...
	ui_stage::init(graphics::root_signature::handle h_root_sig) noexcept
	{
		...
		h_pso = graphics::pso::create(
			pss_root_signature{ .subobj = graphics::g::root_signature_ptr_vec[h_root_sig] },
			pss_ms{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_ui_ms) }) },
			pss_ps{ .subobj = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_ui_ps) }) },
			pss_primitive_topology{ .subobj = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE },
			pss_render_target_formats{ .subobj = D3D12_RT_FORMAT_ARRAY{ .RTFormats{ DXGI_FORMAT_R16G16B16A16_FLOAT }, .NumRenderTargets = 1 } },
			pss_rasterizer{ .subobj = defaults::rasterizer_desc::no_cull },
			pss_blend{ .subobj = defaults::blend_desc::alpha },
...
namespace age::graphics::render_pipeline::forward_plus
{
	...
	presentation_stage::init(root_signature::handle h_root_sig) noexcept
	{
		...
		auto ms_byte_code = shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_presentation_ms) });
		...
		auto&& [ps_byte_code, back_buffer_rt_format] = [&]() {
			...
			case color_space::srgb:
				return std::tuple{
					shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_presentation_sdr_ps) }),
					DXGI_FORMAT_R8G8B8A8_UNORM_SRGB

				};
			case color_space::hdr:
				return std::tuple{
					shader::get_d3d12_bytecode(shader::shader_handle{ to_idx(e::engine_shader_kind::forward_plus_presentation_hdr10_ps) }),
