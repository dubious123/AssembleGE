...
#undef GIBS_SURFEL_PROBE_SPAWN_COVERAGE_NEAR
#undef GIBS_SURFEL_PROBE_KILL_COVERAGE_NEAR
#undef GIBS_CELL_SURFEL_SPAWN_COVERAGE_NEAR
#undef GIBS_CELL_SURFEL_KILL_COVERAGE_NEAR

// 1.f : full hemisphere cover
#undef GIBS_SURFEL_PROBE_SPAWN_COVERAGE_FAR
#undef GIBS_SURFEL_PROBE_KILL_COVERAGE_FAR
...
#undef GIBS_DEBUG_FLAGS_RENDER_SURFEL_PROBES
