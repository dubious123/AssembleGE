...

{
	...
	const float3 irradiance = gibs::sample_irradiance<true, true>(data, surface_data.world_pos, surface_point.world_face_normal, ray_id, ray_hit.object_render_id, ray_hit.primitive_id).xyz;
