...

{
	...
	{
		float4 world_pos = float4(rotate(quaternion, decode_vertex_pos(mesh_header, read_global_vertex_index(mesh_header, mshlt, nth_vertex)) * scale) + pos, 1.f);
