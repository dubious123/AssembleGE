...
struct hrp_gbuffer_opaque_ms_out
{
...
struct hrp_gbuffer_opaque_ms_prim_out
{
...
main_ms(in payload opaque_as_to_ms					  ms_in,
		...
		out vertices hrp_gbuffer_opaque_ms_out		  ms_out_vertex_arr[64],
		out primitives hrp_gbuffer_opaque_ms_prim_out ms_out_prim_arr[126],
