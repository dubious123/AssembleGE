...
{
#define instantiate_template(template_name, t_type) template struct template_name<t_type>
#define value_types                \
...
#define inst_template_step_1(x, ...) FOR_EACH_CTX((instantiate_template, x), AGE_PP_SEMICOLON_I, __VA_ARGS__)
