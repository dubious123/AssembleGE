...
namespace age::graphics::e
{
	...
	AGE_DEFINE_ENUM(engine_shader_kind, uint8,
					...
					forward_plus_gibs_tile_surfel_scatter_cs,
					forward_plus_gibs_cell_surfel_scatter_cs,
					...
					forward_plus_gibs_tile_spawn_kill_cs,
					forward_plus_gibs_cell_spawn_kill_cs,
					...
					forward_plus_gibs_tile_surfel_count_prefix_cs,
